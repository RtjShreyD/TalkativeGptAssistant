...
#
        #data = {}
        #key_value_pairs = re.findall(r'(\w+):\s*([^,]+)', resp)
#
        #for key, value in key_value_pairs:
        #    data[key.strip()] = value.strip('"').strip()
#
        #is_shortlisted = data.get("is_shortlisted")
        #percentage_matching = data.get("percentage_matching")
        #characteristics_matched = data.get("characterstics_matched")
#
        ## Print the extracted values
        #print("is_shortlisted:", is_shortlisted)
        #print("percentage_matching:", percentage_matching)
        #print("characteristics_matched:", characteristics_matched)
#
        #import json
        
        #try:
        #    json_string = resp.replace("'", '"')
        #    data = json.loads(json_string)
#
        #    # Extract the values
        #    is_shortlisted = data.get("is_shortlisted")
        #    percentage_matching = data.get("percentage_matching")
        #    characterstics_matched = data.get("characterstics_matched")
#
        #    # Print the extracted values
        #    print("is_shortlisted:", is_shortlisted)
        #    print("percentage_matching:", percentage_matching)
        #    print("characteristics_matched:", characterstics_matched)
...
def extract_variables_from_response(response_text):
    ...
    for line in lines:
        ...
        # Split each line into key and value pairs using ':'
        parts = line.split(':')
